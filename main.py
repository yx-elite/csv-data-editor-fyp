...
match L5_selection:
    ...
    case '1':
        original_df = pd.read_csv('data/L5SacrumAnteroLateralForce.csv', header=None, nrows=3)
        modified_df = pd.read_csv('data/L5SacrumAnteroLateralForce.csv', header=None, skiprows=3)
    case '2':
        original_df = pd.read_csv('data/L5SacrumAnteroDistalForce.csv', header=None, nrows=3)
        modified_df = pd.read_csv('data/L5SacrumAnteroDistalForce.csv', header=None, skiprows=3)
